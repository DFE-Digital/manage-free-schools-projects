namespace Dfe.ManageFreeSchoolProjects.Constants
{
    public static class RouteConstants
    {
        ...
        public const string ViewRegionAndLocalAuthority = TaskList + "/region-and-localauthority";
        public const string EditRegionAndLocalAuthority = ViewRegionAndLocalAuthority + "/edit";
