...
namespace Dfe.ManageFreeSchoolProjects.Models
{
	public static class Links
	{
		...
		public static LinkItem ByPage(string page) => _links.FirstOrDefault(x => string.Equals(page, x.Page, StringComparison.InvariantCultureIgnoreCase));
		...
		{
			public static readonly LinkItem ConfirmLocalAuthorityInformationTemplateDates = AddLinkItem(page: "/TaskList/LocalAuthorityInformationTemplate/ConfirmLocalAuthorityInformationTemplateDates");
			public static readonly LinkItem RecordLocalAuthorityInformationTemplateDates = AddLinkItem(page: "/TaskList/LocalAuthorityInformationTemplate/RecordLocalAuthorityInformationTemplateDates");
		}
		...
		public static class KeyStagePerformanceSection
		{
			...
			public static readonly LinkItem KeyStage2PerformanceTablesAdditionalInformation = AddLinkItem(page: "/TaskList/KeyStagePerformance/KeyStage2PerformanceTablesAdditionalInformation");
			...
			public static readonly LinkItem KeyStage4PerformanceTablesAdditionalInformation = AddLinkItem(page: "/TaskList/KeyStagePerformance/KeyStage4PerformanceTablesAdditionalInformation");
			...
			public static readonly LinkItem KeyStage5PerformanceTablesAdditionalInformation = AddLinkItem(page: "/TaskList/KeyStagePerformance/KeyStage5PerformanceTablesAdditionalInformation");
		}
