...
namespace Dfe.ManageFreeSchoolProjects.API.Tests.Integration
{
    ...
    public class GetTrustApiTests : ApiTestsBase
    {
        public GetTrustApiTests(ApiTestFixture apiTestFixture) : base(apiTestFixture)
        {
        }

        [Fact]
        public async Task GetTrustApi_Returns_200()
        {
