...
public class ConcernsIntegrationTests : IDisposable
{
	...
	public void Dispose()
	{
		using Dfe.ManageFreeSchoolProjectsDbContext context = _testFixture.GetContext();
	...
	public async Task CanCreateNewConcernCase()
	{
		...
		await using Dfe.ManageFreeSchoolProjectsDbContext context = _testFixture.GetContext();
