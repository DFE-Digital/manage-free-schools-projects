...
using Dfe.ManageFreeSchoolProjects.API.Contracts.Permissions;
using Dfe.ManageFreeSchoolProjects.API.UseCases.Permissions.Cases;
using Dfe.ManageFreeSchoolProjects.API.UseCases.Permissions.Cases.Strategies;
...
namespace Dfe.ManageFreeSchoolProjects.API.Tests.UseCases.Permissions.Cases
{
