...
using Dfe.ManageFreeSchoolProjects.API.Contracts.RequestModels.TrustFinancialForecasts;
using Dfe.ManageFreeSchoolProjects.API.Contracts.ResponseModels.TrustFinancialForecasts;
using Dfe.ManageFreeSchoolProjects.API.Exceptions;
using Dfe.ManageFreeSchoolProjects.API.UseCases;
using Dfe.ManageFreeSchoolProjects.API.UseCases.CaseActions.TrustFinancialForecast;
...
namespace Dfe.ManageFreeSchoolProjects.API.Tests.UseCases.CaseActions.TrustFinancialForecasts;
