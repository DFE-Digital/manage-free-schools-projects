using Dfe.ManageFreeSchoolProjects.API.RequestModels.CaseActions.NTI.WarningLetter;
using Dfe.ManageFreeSchoolProjects.API.ResponseModels.CaseActions.NTI.WarningLetter;
using Dfe.ManageFreeSchoolProjects.API.UseCases.CaseActions.NTI.WarningLetter;
