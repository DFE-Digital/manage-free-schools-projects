        ...
        public static ProjectReport Build(List<ProjectReportSourceData> projectReportSourceData)
        {
            ...
            foreach (var project in projectReportSourceData)
            {
                var tasks = new List<ProjectTaskInformation>
                {
                    ...
                    new ProjectTaskInformation { Task = project.TaskInformation.ReferenceNumbers, TaskName = "Reference numbers", Section = "Reference numbers" },
                    ...
                    new ProjectTaskInformation { Task = project.TaskInformation.FundingAgreementSubmission, TaskName = "Funding agreement submission", Section = "Pre-opening" },
