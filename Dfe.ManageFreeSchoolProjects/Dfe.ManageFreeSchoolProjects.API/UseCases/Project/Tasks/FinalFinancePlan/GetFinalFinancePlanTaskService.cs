...
{
    public class GetFinalFinancePlanTaskService : IGetTaskService
    {
        private readonly MfspContext _context;

        public GetFinalFinancePlanTaskService(MfspContext context)
        {
            _context = context;
        ...
        public async Task<GetProjectByTaskResponse> Get(GetTaskServiceParameters parameters)
        {
            ...
            return result ?? new GetProjectByTaskResponse() { FinalFinancePlan = new() };
        }
    }
}
