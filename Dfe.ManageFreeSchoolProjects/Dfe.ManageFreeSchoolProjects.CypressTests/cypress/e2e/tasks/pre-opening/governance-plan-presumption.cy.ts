...
describe("Testing draft governance plan task", () => {
    ...
    it("Should be able to set a draft governance plan", () => {
        ...
        summaryPage
            ...
            .summaryShows("Shared plan and assessment with local authority").IsEmpty().HasChangeLink()
        ...
        editDraftGovernancePlanPage
            ...
            .checkPlanAndAssessmentSharedWithLa()
        ...
        summaryPage
            ...
            .summaryShows("Shared plan and assessment with local authority").HasValue("Yes")
        ...
        summaryPage
            ...
            .summaryShows("Shared plan and assessment with local authority").IsEmpty()
