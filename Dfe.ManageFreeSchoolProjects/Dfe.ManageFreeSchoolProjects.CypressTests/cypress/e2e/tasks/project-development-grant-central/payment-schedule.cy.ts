...
describe("Payment Schedule Task", () => {
    ...
    it("Should successfully set payment schedule", () => {
        ...
        editPayment
            ...
            .clickContinue()
            .errorForPaymentDueAmount().showsError("Due amount must be between 0 and 200000")
            ...
            .clickContinue()
            .errorForPaymentActualAmount().showsError("Actual amount must be between 0 and 200000")
