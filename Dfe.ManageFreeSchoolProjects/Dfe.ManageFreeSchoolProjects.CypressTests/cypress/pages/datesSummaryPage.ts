class DatesSummaryPage {
    ...
    public verifyDatesSummaryElementsVisible(): this {
        ...
        cy.getByClass("govuk-link").eq(0).contains("Change");
        ...
        cy.getByClass("govuk-link").eq(1).contains("Change");
        ...
        cy.getById("govuk-checkboxes__input").should("be.visible").should("not.be.checked");
    ...
    public selectChangePreopeningToGoToDatesDetails(): this {
        cy.getByClass("govuk-link").eq(0).click();
